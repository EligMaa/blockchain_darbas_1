...
vector<string> eiluciu_skaitymas_papildoma( string& pav) {
    ifstream failas(pav);
    string eilute;
...
double laiko_matavimas_papildoma( string& ivestis) {
...
void testavimas_papildoma( string pav) {
    vector<string> lines = eiluciu_skaitymas_papildoma(pav);
    
    for (int eiluciu_sk = 1; eiluciu_sk <=17000 ; eiluciu_sk *= 2) {
        ...
        for (int repeat = 0; repeat < 5; ++repeat) {
            laikas += laiko_matavimas_papildoma(ivestis);
        }
